...
def main():
    ...
    episode = 3001 # episode 정해주기.

    action_space = 2
    state_space = 4
    env = gym.make('CartPole-v1')

    multi_step_size = 3 # 1 = 1 step-TD and TD(0), 2 = 2 step-TD, 3 = 3 step-TD
    atom_size = 51
    vmin = -10
    vmax = 10
    ...
    Rainbow = Rainbow_DQN.rainbow_dqn(state_space, action_space, multi_step_size, batch_size, atom_size, vmin, vmax)
    ...
    for epi in range(episode):
        ...
        for i in range(maximum_steps):
            ...
            action = Rainbow.action_policy(torch.Tensor(obs))
        ...
        if epi % print_interval == 0 and epi != 0:
            ...
            score = 0
            with open('3step_Rainbow.p', 'wb') as file:
